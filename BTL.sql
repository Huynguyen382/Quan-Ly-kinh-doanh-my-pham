CREATE DATABASE BaiTapLon ON
(
	NAME = BaiTapLon,
	FILENAME = 'D:\Tai_Lieu_Hoc_Tap\ThuchanhSQL_LeVanQuangHuy_2110A04\BaiTapLon.mdf'
)
...
(
sMaNSX VARCHAR (20) PRIMARY KEY NOT NULL,
...
sMaNSX VARCHAR (20) NOT NULL,
sMaLoai VARCHAR (20) NOT NULL,
sMaNCC VARCHAR (20) NOT NULL,
fSoLuongKho FLOAT NOT NULL,
)

ALTER TABLE tblSanPham ALTER COLUMN sMaNSX NVARCHAR(20)
...
sDiaChi NVARCHAR (50) NOT NULL,
dNgaySinh DATETIME NOT NULL,
dNgayVaoLam VARCHAR (20) NOT NULL,
sCCCD VARCHAR (50) UNIQUE NOT NULL,
fLuongCoBan FLOAT NOT NULL,
fPhuCap FLOAT NOT NULL
)

ALTER TABLE tblNhanVien ALTER COLUMN dNgayVaoLam DATETIME
...
CREATE TABLE tblCHITIET_HD_BANMP
(
...
CREATE TABLE tblCHITIET_HD_NHAPMP
(
...
CONSTRAINT FK_sanPham_Loai FOREIGN KEY (sMaLoai) REFERENCES tblLoaiMiPham (sMaLoai),
CONSTRAINT FK_sanPham_NCC FOREIGN KEY (sMaNCC) REFERENCES tblNhaCungCap(sMaNCC)
...
ALTER TABLE tblCHITIET_HD_BANMP
...
ALTER TABLE tblCHITIET_HD_NHAPMP
...
-- tblLoaiMiPham
INSERT INTO tblLoaiMiPham (sMaLoai, sTenLoai)
VALUES ('L01', N'Sữa rửa mặt'),
	   ('L02', N'Nước tẩy trang'),
	   ('L03', N'Son'),
	   ('L04', N'Kem chống nắng'),
	   ('L05', N'Dầu gội đầu'),
	   ('L06', N'Serum'),
	   ('L07', N'Toner');
...
-- tblSanPham
INSERT INTO tblSanPham(sMaSanPham,sTenSanPham,fDonGia,sNuocSX,sMaNSX,sMaLoai,sMaNCC,fSoLuongKho)
VALUES ('SP01', N'Sữa rửa mặt Cetaphil 125ml', 100000, N'Mỹ', 'NSX01', 'L01', 'NCC01',1000),
	   ('SP02', N'Nước tẩy trang Senka 125ml', 90000, N'Nhật bản', 'NSX02', 'L02', 'NCC02',1000),
	   ('SP03', N'Dầu gội đầu Sunsilk 650g', 112000, N'Anh', 'NSX03', 'L05', 'NCC03',1000),
	   ('SP04', N'Nước tẩy trang Dove 235ml', 98000, N'Anh', 'NSX04', 'L02', 'NCC04',1000),
	   ('SP05', N'Son dưỡng môi Vaseline lô hội', 50000, N'Mỹ', 'NSX05', 'L03', 'NCC05',1000),
	   ('SP06', N'Kem chống nắng Innisfree SPF50', 204000, N'Hàn Quốc', 'NSX06', 'L04', 'NCC01',1000),
	   ('SP07', N'Kem chống nắng Sunplay SPF50+', 79000, N'Nhật Bản', 'NSX07', 'L04', 'NCC02',1000),
	   ('SP08', N'Serum Innisfree trà xanh dưỡng ẩm 80ml', 506000, N'Hàn Quốc', 'NSX06', 'L06', 'NCC02',1000),
	   ('SP09', N'Toner Innisfree trà xanh 160ml', 540000, N'Hàn Quốc', 'NSX06', 'L07', 'NCC02',1000),
	   ('SP10', N'Sữa rửa mặt Senka  125ml', 65000, N'Nhật Bản', 'NSX02', 'L01', 'NCC03',1000),
	   ('SP11', N'Nước tẩy trang Senka 230ml', 103000, N'Nhật Bản', 'NSX02', 'L02', 'NCC04',1000),
	   ('SP12', N'Dầu gội đầu Dove 640g', 155000, N'Anh', 'NSX04', 'L05', 'NCC06',1000),
	   ('SP13', N'Kem chống nắng Dove SPF 90', 250000, N'Anh', 'NSX04', 'L05', 'NCC06',1000),
	   ('SP14', N'Sữa rửa mặt Innisfree trà xanh', 260000, N'Hàn Quốc', 'NSX06', 'L01', 'NCC06',1000),
	   ('SP15', N'Son dưỡng môi Vaseline trà xanh', 50000, N'Mỹ', 'NSX05', 'L03', 'NCC02',1000);
...
--tblChiTietHoaDon
INSERT INTO tblCHITIET_HD_BANMP(sSoHD, sMaSanPham, fSoLuongMua, fDonGia,fMucGiamGia)
...
INSERT INTO tblCHITIET_HD_NHAPMP (sSoHDNhap, sMaSanPham, fSoLuongNhap, fGiaNhap)
...
AS
BEGIN
-- DELETE tblNhanVien FROM tblNhanVien JOIN tblHoaDon ON tblNhanVien.sMaNV = tblHoaDon.sMaNV
-- WHERE tblNhanVien.sMaNV = @maNV AND tblHoaDon.sMaNV = @maNV
